...
<template>
  ...
  <div v-if="page == 1" class="bootstrapCard">
    <div style="display:flex;width:100%;height:100%;justify-content: space-between;padding:0 2%;" class="bootstrapCardTop">
      <h1>遊樂設施</h1>
      <div style="display:flex;align-items: center;" class="botSearch">
        ...
        <i @click="this.searchFacilityRegx"  style="margin:0 5%;font-size:24pt;cursor:pointer;"  class="fa-solid fa-magnifying-glass"></i>
      </div>
    </div>
    <div class="cardPlace">
