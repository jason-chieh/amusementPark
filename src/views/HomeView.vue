...
<template>
  ...
  <div v-if="page == 2" class="mapByMyself">
    ...
    <svg version="1.1" id="圖層_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
      ...
      <!-- 測試點選地圖後，顯示地圖資訊 -->
      <!-- 島嶼1 刺激飛天島-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="刺激飛天島" data-content="飛天島好好玩">
      ...
      <!-- 島嶼2 溫馨親子島-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="溫馨親子島" data-content="親子島好好玩">
        <defs>
      ...
      <!-- 島嶼3 凍骨冰山島-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="凍骨冰山島" data-content="冰山島好好玩">
        <defs>
          <path id="SVGID_19_"
      ...
      <!-- 島嶼4 慢活樂園島-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="慢活樂園島" data-content="樂園島好好玩">
        <defs>
          <path id="SVGID_21_"
      ...
      <!-- 島嶼5 驚險火山島-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="驚險火山島" data-content="火山島好好玩">
        <defs>
      ...
      <!-- 島嶼6 孤島_停車場-->
      <g class="st1 island" @click="this.zoomAndShowText" data-message="孤島" data-content="這是停車場你知道的">
        <defs>
  ...
  <div v-if="page == 4" class="ticketAccess">
    ...
    <div class="onlinePlatformTable">
      ...
      <div class="onlinePlatform">
        <a href="https://www.klook.com/zh-TW/" target="_blank">
