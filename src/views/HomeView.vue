...
<template>
  ...
  <div v-if="page == 5" class="gourmetRestaurant">
    ...
    <div class="restaurant1Area" v-for=" item in restaurant1AreaArr">
      <div class="leftPart1">
        <img :src=item.photo alt="FriBay" style="width: 600px; height: 350px; display:flex; margin:auto;">
      </div>
    ...
    <div class="pagination" style="justify-content:center; margin-bottom: 2vh;">
      ...
      <button style="border:none; border-radius: 10%;" @click="changePage(1)" :disabled="currentPage * pageSize >= restaurant1AreaArr.length">▶️</button>
    </div>
  </div>
